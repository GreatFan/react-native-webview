...
import com.reactnativecommunity.greatwebview.events.GreatTopLoadingErrorEvent;
import com.reactnativecommunity.greatwebview.events.GreatTopHttpErrorEvent;
import com.reactnativecommunity.greatwebview.events.GreatTopLoadingFinishEvent;
import com.reactnativecommunity.greatwebview.events.GreatTopLoadingProgressEvent;
import com.reactnativecommunity.greatwebview.events.GreatTopLoadingStartEvent;
import com.reactnativecommunity.greatwebview.events.GreatTopMessageEvent;
import com.reactnativecommunity.greatwebview.events.GreatTopShouldStartLoadWithRequestEvent;
 ...
 */
@ReactModule(name = GreatRNCWebViewManager.REACT_CLASS)
public class GreatRNCWebViewManager extends SimpleViewManager<WebView> {
  ...
  protected GreatWebViewConfig mWebViewConfig;
  ...
  public GreatRNCWebViewManager() {
    mWebViewConfig = new GreatWebViewConfig() {
      public void configWebView(WebView webView) {
      }
    };
  }

  public GreatRNCWebViewManager(GreatWebViewConfig webViewConfig) {
  ...
  protected WebView createViewInstance(ThemedReactContext reactContext) {
    ...
    webView.setDownloadListener(new DownloadListener() {
      public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimetype, long contentLength) {
        ...
        GreatRNCWebViewModule module = getModule(reactContext);
  ...
  public Map getExportedCustomDirectEventTypeConstants() {
    ...
    export.put(GreatTopLoadingProgressEvent.EVENT_NAME, MapBuilder.of("registrationName", "onLoadingProgress"));
    export.put(GreatTopShouldStartLoadWithRequestEvent.EVENT_NAME, MapBuilder.of("registrationName", "onShouldStartLoadWithRequest"));
    export.put(ScrollEventType.getJSEventName(ScrollEventType.SCROLL), MapBuilder.of("registrationName", "onScroll"));
    export.put(GreatTopHttpErrorEvent.EVENT_NAME, MapBuilder.of("registrationName", "onHttpError"));
    return export;
  }
  ...
  public static GreatRNCWebViewModule getModule(ReactContext reactContext) {
    return reactContext.getNativeModule(GreatRNCWebViewModule.class);
  }
  ...
  protected static class RNCWebViewClient extends WebViewClient {
    ...
    public boolean shouldOverrideUrlLoading(WebView view, String url) {
      ...
      dispatchEvent(
        view,
        new GreatTopShouldStartLoadWithRequestEvent(
          view.getId(),
    ...
    public void onReceivedError(
      ...
      dispatchEvent(
        webView,
        new GreatTopLoadingErrorEvent(webView.getId(), eventData));
    }
    ...
    public void onReceivedHttpError(
      ...
      if (request.isForMainFrame()) {
        ...
        dispatchEvent(
          webView,
          new GreatTopHttpErrorEvent(webView.getId(), eventData));
      }
    }
    ...
    protected void emitFinishEvent(WebView webView, String url) {
      dispatchEvent(
        webView,
        new GreatTopLoadingFinishEvent(
          webView.getId(),
          createWebViewEvent(webView, url)));
    }
  ...
  protected static class RNCWebChromeClient extends WebChromeClient implements LifecycleEventListener {
    ...
    public void onProgressChanged(WebView webView, int newProgress) {
      ...
      dispatchEvent(
        webView,
        new GreatTopLoadingProgressEvent(
          webView.getId(),
          event));
    }
    ...
    public void onMessage(String message) {
      ...
      if (mRNCWebViewClient != null) {
        ...
        webView.post(new Runnable() {
          ...
          public void run() {
            ...
            if (mCatalystInstance != null) {
              ...
              dispatchEvent(webView, new GreatTopMessageEvent(webView.getId(), data));
            }
          }
        });
      } else {
        ...
        if (mCatalystInstance != null) {
          ...
          dispatchEvent(this, new GreatTopMessageEvent(this.getId(), eventData));
        }
      }
    }
