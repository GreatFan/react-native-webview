...
@ReactModule(name = GreatRNCWebViewModule.MODULE_NAME)
public class GreatRNCWebViewModule extends ReactContextBaseJavaModule implements ActivityEventListener {
  ...
  public GreatRNCWebViewModule(ReactApplicationContext reactContext) {
    super(reactContext);
  ...
  public void startPhotoPickerIntent(ValueCallback<Uri> filePathCallback, String acceptType) {
    ...
    if (chooserIntent.resolveActivity(getCurrentActivity().getPackageManager()) != null) {
      ...
      Log.w("GreatRNCWebViewModule", "there is no Activity to handle this Intent");
    }
  }
